...
namespace CoreCodeCamp.Data
{
    public class CampContext : DbContext
    {
        ...
        public CampContext(IConfiguration configuration, DbContextOptions options) : base(options)
        {
        ...
        {
            optionsBuilder.UseNpgsql(_configuration.GetConnectionString("CoreCodeCamp"));
        }
